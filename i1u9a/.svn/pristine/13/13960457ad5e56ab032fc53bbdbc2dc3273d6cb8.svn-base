 ...
 * these tests to pass without inserting any semantic actions into your parser
 * specification file.
 * <p>
 * The tests in this file are written in an order that can be followed if you
 * want to develop your parser incrementally, staring with the tests at the top
 * of the file, and working your way down.
 * 
 * @author kdvolder
 */
public class Test3Parse {
	 ...
	 * accept methods, to see whether some input is accepted by the parser. The
	 * subclass Test4Parse refines these tests by overriding this accept method
	 * to also verify the parse tree structure.
	 */
	...
	public void testSmallest() throws Exception {
		// The smallest program has one print statement with the smallest
		// expression.
		accept("print 1");
	}
	...
	// Note: some of the created test programs here are not correct. They use
	// undeclared variables
	// and may have type errors... but they should pass by the parser. The
	// parser doesn't
